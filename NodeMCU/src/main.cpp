...
#define WIFI_SSID "PC"
#define WIFI_PASSWORD "senhapc123"
 ...
 *
 */
#define API_KEY "AIzaSyAX2AihxyXKnvMUyj5rMJseUPAN2f35BKs"

/* 3. Define the user Email and password that already registerd or added in your project */
#define USER_EMAIL "admin@coffeemachine.com"
#define USER_PASSWORD "coffeemachine"

/* 4. If work with RTDB, define the RTDB URL */
#define DATABASE_URL "https://se2022-1-fe22f-default-rtdb.firebaseio.com/" //<databaseName>.firebaseio.com or <databaseName>.<region>.firebasedatabase.app
 ...
 */
#define DATABASE_SECRET "ip4wEYV1lZBkxoiUHjVd6a5B5z3WfPQQcGqF7bgy"
...
void loop()
{
    temperatura = SSerial.read();
    Serial.println(temperatura);
    //Firebase.setFloat(fbdo, "temperatura", temperatura);
